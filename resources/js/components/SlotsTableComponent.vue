<template>
    <div>
        <el-table :data="tableData" :span-method="objectSpanMethod" size="mini" border style="width: 100%">
            <el-table-column prop="registration_type" label="Registration Type" align="center" width="180">
            </el-table-column>
            <el-table-column prop="description" label="Description" align="center" width="180">
            </el-table-column>
            <el-table-column prop="event_date" label="Event Date" align="center" width="180">
            </el-table-column>
            <el-table-column prop="seat_count" label="Total Slots" align="center" width="130">
            </el-table-column>
            <el-table-column prop="taken" label="Taken" align="center" width="130">
            </el-table-column>
            <el-table-column prop="available" label="Remaining" align="center" width="130">
            </el-table-column>
            <el-table-column prop="activities" label="Activity">
