                                    ...
                                    <td colspan="3">
                                        <el-row :gutter="8">
                                            ...
                                            <el-col class="pb-1" :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
                                                ...
                                                <el-date-picker
                                                    size="mini"
                                                    :class="{'has-error' : (errors[i] && errors[i]['birthday'])}"
                                                    style="width: 100%"
                                                    v-model="guest.birthday"
                                                    type="date"
                                                    placeholder="Pick a day">
                                                </el-date-picker>
                                                <small v-if="errors[i] && (errors[i]['birthday'] || errors[i]['camper_category'])" class="text-error">
                                                    <span v-if="errors[i]['birthday']">{{ errors[i]['birthday'] }}</span>&nbsp;
                                                </small>
                                            </el-col>
                                            <el-col class="pb-1" :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
                                                <label class="text-sm">Camper Category</label>
                                                <el-select 
                                                    :class="{'has-error' : (errors[i] && errors[i]['camper_category']) || (errors[i] && errors[i]['invalid'])}" 
                                                    size="mini" 
                                                    v-model="guest.camper_category" 
                                                    placeholder="Choose">
                                                ...
                                                <small v-if="errors[i] && (errors[i]['birthday'] || errors[i]['camper_category'])" class="text-error">
                                                    <span v-if="errors[i]['camper_category']">{{ errors[i]['camper_category'] }}</span>&nbsp;
                                                </small>
                                            </el-col>
                                            <el-col class="pb-1" :xs="12" :sm="12" :md="12" :lg="8" :xl="8">
                                                <label class="text-sm">Holy Ghost seeker?</label>
                                                <el-select 
                                                    :class="{'has-error' : (errors[i] && errors[i]['holy_ghost_seeker']) || (errors[i] && errors[i]['invalid'])}" 
                                                    size="mini" 
                                                    v-model="guest.holy_ghost_seeker" 
                                                    placeholder="Choose">
                                                    <el-option
                                                ...
                                                <small v-if="errors[i] && (errors[i]['inviter_complete_name'] || errors[i]['holy_ghost_seeker'])" class="text-error">
                                                    <span v-if="errors[i]['holy_ghost_seeker']">{{ errors[i]['holy_ghost_seeker'] }}</span>&nbsp;
                                                </small>
                                            </el-col>
                                            <el-col class="pb-1" :xs="12" :sm="12" :md="12" :lg="16" :xl="16">
                                                <label class="text-sm">Inviter Complete Name</label>
                                                <el-input
                                                    size="mini"
                                                    placeholder="Inviter Complete Name"
                                                    :class="{'has-error' : (errors[i] && errors[i]['inviter_complete_name']) || (errors[i] && errors[i]['invalid'])}"
                                                    v-model="guest.inviter_complete_name">
                                                </el-input>
                                                <small v-if="errors[i] && (errors[i]['inviter_complete_name'] || errors[i]['holy_ghost_seeker'])" class="text-error">
                                                    <span v-if="errors[i]['inviter_complete_name']">{{ errors[i]['inviter_complete_name'] }}</span>&nbsp;
                                                </small>
                                            </el-col>
                                            <el-col class="pb-1" :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
                                                <label class="text-sm">Transportation</label>
                                                <el-select 
                                                    :class="{'has-error' : (errors[i] && errors[i]['transportation']) || (errors[i] && errors[i]['invalid'])}" 
                                                    size="mini" 
                                                ...
                                                <small v-if="errors[i] && (errors[i]['tshirt_size'] || errors[i]['transportation'])" class="text-error">
                                                    <span v-if="errors[i]['transportation']">{{ errors[i]['transportation'] }}</span>&nbsp;
                                                </small>
                                            </el-col>
                                            <el-col class="pb-1" :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
                                                <label class="text-sm">T-shirt Size</label>
                                                <el-select 
                                                    :class="{'has-error' : (errors[i] && errors[i]['tshirt_size']) || (errors[i] && errors[i]['invalid'])}" 
                                                    size="mini" 
                                                    v-model="guest.tshirt_size" 
                                                    placeholder="Choose">
                                                    <el-option
                                                ...
                                                <small v-if="errors[i] && (errors[i]['tshirt_size'] || errors[i]['transportation'])" class="text-error">
                                                    <span v-if="errors[i]['tshirt_size']">{{ errors[i]['tshirt_size'] }}</span>&nbsp;
                                                </small>
                                            </el-col>
                                        </el-row>
