<template>
    <div>
        <div class="row justify-content-center">
            <div class="col-md-6">
                <component ref="myChild" v-bind:is="currentTabComponent" v-bind:data="currentTabData" :slots="slots"
                    @change-step="changeStep" @reset="reset" @submit="submit" :event="event" />
            </div>
        </div>
        <div class="row justify-content-center mb-5">
            <div class="col-md-6" :style="`--theme-color: ${themeColor}`">
                ...
                " type="theme" class="el-button--theme" @click="$refs.myChild.submitForm('next')">
                    Submit
                </el-button>
                <el-button v-else plain @click="$refs.myChild.submitForm('next')">
                    Next
                </el-button>
                <el-progress :stroke-width="5" style="width:fit-content;display: inline;" define-back-color="#595353"
                    class="m-2 float-end" :color="customColorMethod" :percentage="(100 * currentStep) / 3"
...
<script>
import Step1 from "../../../components/Registration/4/Step1.vue";
import Step2 from "../../../components/Registration/4/Step2.vue";
import Step3 from "../../../components/Registration/4/Step3.vue";
