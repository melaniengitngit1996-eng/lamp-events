...
<center>
<label style="font-size: 20px; color: #6ea56e; font-weight: 600;">@if($event_slug == 1226292026) Registration Confirmed! @else Booking Confirmed! @endif<label>
</center>
<br />
<br />
